...
pub struct CreateAssociationMember {
    #[serde(rename = "admin", skip_serializing_if = "Option::is_none")]
    pub admin: Option<bool>,
    #[serde(rename = "internal_username", skip_serializing_if = "Option::is_none")]
...
impl CreateAssociationMember {
    pub fn new() -> CreateAssociationMember {
